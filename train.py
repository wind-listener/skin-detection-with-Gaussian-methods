...
def parse_args():
    ...
    parser.add_argument('--train', type=str, default='resized_image/labelme')
    parser.add_argument('--val', type=str, default='resized_image/labelme')
...
if __name__ == '__main__':
    ...
    # print('xxxxxxxxxxxxxx', n_train, n_val)
    # train_set, val_set = random_split(args.dataset, [n_train, n_val])
